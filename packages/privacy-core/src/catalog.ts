export const CATALOG_VERSION = "fr-eu-2026-09-22.draft-2";
...
const entries = [
  ...
  ["R-005", "Cadre contractuel à documenter", "Une relation de sous-traitance déclarée appelle une référence de contrat ou d’acte. Sa présence ne valide pas ses clauses. Les appréciations et leurs justificatifs restent à documenter dans la revue contractuelle.", "relation déclarée, contrat, périmètre", chapter(4), "28"],
...
export const CATALOG: readonly DocumentaryRule[] = entries.map(([id, title, explanation, facts, source, article]) => ({
  id, title, explanation, facts, source, article, version: id === "R-005" ? 2 : 1, result: "documentary-question", jurisdiction: "UE / France",
