...
## Grilles transmises le 23 septembre 2026

| Repère | Document et version | Usage et portée |
| --- | --- | --- |
| A05 | Estelle De Marco, Guide d’analyse RGPD, v1.0 ; onglets Cartographie et ET1 analyse RGPD | Comparaison des rubriques CR1 à CR14 et adaptation partielle en aides contextuelles. Mention CC BY 4.0, Cartographie A43. Originaux et exemples exclus du dépôt et des actifs publics. Correction de lecture : PC, personne concernée, en B20. |
