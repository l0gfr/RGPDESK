...
def verify(root, commit):
    ...
    allowed = re.compile(r"(?:site/(?:index\.html|app/privacy/(?:index\.html|verify/index\.html|confidentialite/index\.html|guide/index\.html|faq/index\.html|soutenir/index\.html|demo/(?:index\.html|(?:registre|sous-traitance|aipd)/index\.html))|_astro/[A-Za-z0-9_.-]+\.(?:js|css|woff2?|svg|png|webp)|(?:LICENSE|NOTICE|THIRD_PARTY_NOTICES|TRADEMARKS)\.txt|robots\.txt|release\.json)|apache/(?:rgpdesk\.fr\.conf|rgpdesk-bootstrap\.conf)|verify-release\.py)")
    expected = set()
    ...
    required = {"site/index.html", "site/app/privacy/index.html", "site/app/privacy/verify/index.html", "site/app/privacy/confidentialite/index.html", "site/app/privacy/guide/index.html", "site/LICENSE.txt", "site/NOTICE.txt", "site/THIRD_PARTY_NOTICES.txt", "site/TRADEMARKS.txt", "site/robots.txt", "site/release.json", "apache/rgpdesk.fr.conf", "apache/rgpdesk-bootstrap.conf", "verify-release.py"}
