<script lang="ts">
  import { createDataGroup, dataGroupOpenPoints, knowledgeText, MINIMISATION_LABELS, type Activity, type Workspace } from "@rgpdesk/privacy-core";
...
<section class="data-groups" aria-label="Groupes de données et parcours">
  ...
  <p class="help">Si les usages ou les durées diffèrent, distinguez les groupes. Les champs vides restent des questions ouvertes. Ne saisissez aucune donnée individuelle.</p>
