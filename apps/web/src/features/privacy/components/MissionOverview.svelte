<script lang="ts">
  import { dpoChanges, rightsDeadline, breachDeadline, evaluateWorkspace, type Activity, type Workspace } from "@rgpdesk/privacy-core";
  import Pictogram from "./Pictogram.svelte";
  import Icon from "./Icon.svelte";
  let { workspace, busy, onNavigate, onEdit, onCase }: { workspace: Workspace; busy: boolean; onNavigate: (panel: "dpo" | "pia" | "pia-sharing" | "flows" | "analysis" | "register" | "organization" | "documents" | "actions" | "delivery" | "backup" | "import") => void; onEdit: (activity: Activity) => void; onCase: (id: string) => void } = $props();
