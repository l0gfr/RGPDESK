<script lang="ts">
  ...
  let { workspace, busy, onNavigate, onEdit }: { workspace: Workspace; busy: boolean; onNavigate: (panel: "flows" | "analysis" | "register" | "organization" | "documents" | "actions" | "delivery" | "backup" | "import") => void; onEdit: (activity: Activity) => void } = $props();
