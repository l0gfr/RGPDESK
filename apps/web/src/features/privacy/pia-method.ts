...
export const PIA_SOURCES = {
  law: "https://www.cnil.fr/fr/reglement-europeen-protection-donnees/chapitre4",
...
const question = (id: string, title: string, prompt: string, evidence: string, reference: string, chapter = "chapitre4"): ReviewQuestion => ({ id, title, question: prompt, evidence, reference, source: `https://www.cnil.fr/fr/reglement-europeen-protection-donnees/${chapter}`, nature: "Texte du RGPD ; questions rédigées par RGPDESK · portée UE/France" });
